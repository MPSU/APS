...
|Операция|={cmp, mod, opcode}|result_o               | Действие                                              |
|--------|-------------------|-----------------------|-------------------------------------------------------|
...
|Операция|={cmp, mod, opcode}| flag_o               | Действие                          |
|--------|-------------------|----------------------|-----------------------------------|
