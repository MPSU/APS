...
Абстрагирование, будучи важным концептом в компьютерных науках, предоставляет нам возможность создавать сложные системы, объединяя их из множества уровней абстракций. Начиная с уровней абстрагироавния вычислительной системы, который включает в себя вентили, модули, микроархитектуру, архитектуру, операционную систему и программы, мы видим, что каждый уровень служит основой для следующего. В этом контексте архитектура выступает как фундамент, на котором строится программный стек абстракций, который, в свою очередь, включают в себя ассемблеры, языки высокого уровня, фреймворки и метафреймворки, обеспечивая более высокий уровень и удобство при разработке программ. Давайте немного глубже погрузимся в этот стек.
...
Компилятор, который подойдет для данной задачи (для запуска в операционной системе Windows) уже установлен в аудиториях. Но если что, вы можете скачать его [отсюда](https://github.com/xpack-dev-tools/riscv-none-elf-gcc-xpack/releases/download/v13.2.0-1/xpack-riscv-none-elf-gcc-13.2.0-1-win32-x64.zip) ~550 МБ.
