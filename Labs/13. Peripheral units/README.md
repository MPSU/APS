...
Помимо процессора и памяти, третьим ключевым элементом архитектуры вычислительной машины является **система ввода/вывода**, обеспечивающая обмен информации между ядром вычислительной машины и разнообразными периферийными устройствами [1, стр. 351].
