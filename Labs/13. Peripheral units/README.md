...
Вам необходимо добавить в проект все эти файлы. Последние три файла отвечают за инициализацию памятей шрифтов (шрифт — [easycode](https://fontstruct.com/fontstructions/show/346317/easycode), кодировка — [CP866](https://ru.wikipedia.org/wiki/CP866)), символов и цветов. Инициализация будет выполнена автоматически. Главное, чтобы файлы были добавлены в проект.
