...
6. Проверьте работу процессорной системы с помощью моделирования.
   ...
   3. При моделировании светодиодов лучше уменьшить значение, до которого считает счетчик в режиме "моргания" в 10 раз, чтобы уменьшить время моделирования (Для варианта клавиатура + светодиоды, чтобы мигания стали видны на временной диаграмме, это значение необходимо уменьшить ещё сильнее, до числа порядка $10^3$). Перед генерацией битстрима это значение будет необходимо восстановить.
