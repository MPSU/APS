...
| Коршунов Андрей Владимирович                                | Профессиональные консультации по темам проектирования синтеза цифровых схем, помощь в написании документа "Этапы реализации проекта в ПЛИС".                                                              |
