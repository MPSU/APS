...
Авторами курса в его текущем виде являются: [Попов Михаил Геннадьевич](https://t.me/gr33nka) и [Солодовников Андрей Павлович](https://t.me/gr33nka).

С подготовкой курса и репозитория помогали студенты и сотрудники института МПСУ: <!--- В алфавитном порядке -->
...
| Стрелков Даниил Владимирович                                | Отработка материалов, подготовка тестбенчей для лабораторных работ.                                                                                                                                      |
...
Кроме того, в написании конспектов лекций принимали участие студенты различных институтов университета МИЭТ.
